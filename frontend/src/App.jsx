...
const API_URL = isLocal ? 'http://localhost:8000' : 'https://nehachikle-kaizen-os.hf.space';
const WS_URL  = isLocal ? 'ws://localhost:8000/ws' : 'wss://nehachikle-kaizen-os.hf.space/ws';
